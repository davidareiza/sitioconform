...
$recipientEmail='davidareizza@gmail.com';
$recipientName='El recibidor de correos';
...
$senderMessage= $_POST['contact-messgae'];
$senderSubject = 'Someone send you a message on magiclog.com' . $senderName;
...
if(!$mail->Send()) {
	...
	echo '<div class="alert alert-success" role="alert">Thank you for you interest on Magic Log. We will contact you shortly.</div>';
}
?>